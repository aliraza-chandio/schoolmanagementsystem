...
<html lang="en">
   <head>
      ...
      <link rel="icon" href="/public/assets/images/favicon.ico" type="image/ico" />
                  ...
                  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                     <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                           ...
                           <li>
                              <a><i class="fa fa-user"></i> Teacher <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                                 <li><a href="/teachers">View All</a></li>
                                 <li><a href="/teachers/create">Create</a></li>
                              </ul>
                           </li>
                           <li>
                              <a><i class="fa fa-user"></i> Classes <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                  ...
                  <nav class="nav navbar-nav">
                     <ul class=" navbar-right">
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                           ...
                           <img src="/public/assets/images/img.jpg" alt="">John Doe
                           </a>
                        ...
                        <li role="presentation" class="nav-item dropdown open">
                           ...
                           <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                              <li class="nav-item">
                                 ...
                                 <span class="image"><img src="/public/assets/images/img.jpg" alt="Profile Image" /></span>
                                 <span>
